...
def get_and_transfer_raw_data_to_ods_pg(**context):
    """
    Основная функция DAG: переносит данные из S3 (MinIO) в PostgreSQL DWH
    
    Процесс:
    1. Получает даты интервала выполнения из контекста Airflow
    2. Читает Parquet файлы из S3 за указанную дату
    3. Преобразует названия колонок из camelCase в snake_case
    4. Вставляет данные в таблицу PostgreSQL
    """
